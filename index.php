<?php include "view/header.php"; ?>
    <div class="bg-dark py-4" style="margin-top:4em">
      <div class="container" style="min-height: 560px;">
        <div class="row">
          <div class="d-flex flex-column col-12 col-md-6 px-2" style="min-height: 560px;">
              ...
              <div class="container-fluid px-0 h-100">
                <div class="row">
                  ...
                  <div class="col-sm-6 col-md-6 px-0 img-overlay-container">
                    <a href="#">
                      <img class="img-fluid" src="http://cdn-static.denofgeek.com/sites/denofgeek/files/2018/02/fallout.jpg"  style="width:100%;height:198px" alt="">
                      <div class="overlay">Mission: Impossible - Fallout (2018)</div>
                    </a>
                  </div>
                  <div class="col-sm-6 col-md-6 px-0 img-overlay-container">
                    <a href="#">
                      <img class="img-fluid" src="http://bestwatchbrandshq.com/wp-content/uploads/2018/04/Denzel-Washington-Watch-In-The-Equalizer-2-Movie.jpg" style="width:100%;height:198px" alt="">
