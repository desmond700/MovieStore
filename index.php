              ...
              <div class="container-fluid px-0 h-100">
                <div class="row justify-content-center">
                  <div class="col-md-12 px-0 img-overlay-container">
                    <a href="#">
                      <img class="img-fluid h-100" src="https://i.ytimg.com/vi/I5N8GymdRio/maxresdefault.jpg" alt="">
            ...
            <div class="h-100 px-0">
              <div class="container-fluid px-0 h-100">
                <div class="row h-100 mx-0  justify-content-center">
                  <div class="col-sm-6 col-md-6 px-0 img-overlay-container">
                    <a href="#">
                      <img class="img-fluid h-100" src="http://s3-us-west-1.amazonaws.com/mediastinger/wp-content/uploads/2018/04/06152304/Rampage-2018-after-credits-hq.jpg" alt="">
                      <div class="overlay">Rampage (2018)</div>
                    </a>
                  </div>
                  <div class="col-sm-6 col-md-6 px-0 img-overlay-container">
                    <a href="#">
                      <img class="img-fluid h-100" src="http://cdn.wegotthiscovered.com/wp-content/uploads/2017/09/21082913_264370074054238_4920788646889854495_o.jpg" alt="">
                      <div class="overlay">Avengers: Infinity War (2018)</div>
                    </a>
                  </div>
                  <div class="d-flex col-md-12 px-0 img-overlay-container">
                    <a href="#">
                      <img class="img-fluid h-100" src="https://cdn.vox-cdn.com/thumbor/Ttwwar-56OJ21pROmryNCbDEBKs=/0x0:1382x2048/1200x800/filters:focal(175x884:395x1104)/cdn.vox-cdn.com/uploads/chorus_image/image/59798029/deadpool_2_poster.0.jpg" style="width:100%;height:px" alt="">
